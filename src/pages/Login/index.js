...
const Login = () => {
  ...
  return (
    <React.Fragment>
      ...
      ></div>
      <div className="container mx-auto p-32 relative">
        <div className="bg-base-100 p-8 mt-12 my-5 md:mt-12 max-w-4xl mx-auto rounded-box">
          ...
          <div className="form-control md:w-5/12 w-9/12 mt-5 mx-auto grid justify-items-stretch">
            ...
            <div className="text-right mt-8">
              <h6>
                <a href='/Editpassword' className="link link-primary">ลืมรหัสผ่าน ?</a>
              </h6>
            </div>
          </div>
          ...
          <div className="text-center mt-8">
            <h6>
              ไม่มีบัญชี <a href='/Register' className="link link-primary">สร้างบัญชีใหม่</a>
            </h6>
          </div>
